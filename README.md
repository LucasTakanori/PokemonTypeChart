...
Typewise is an interactive memory trainer for the modern 18-type Pokémon matchup chart (Generation VI onward). Attacking types run down the left and defending types run across the top.
...
- Practice mode with immediate feedback and Test mode with hidden scoring
